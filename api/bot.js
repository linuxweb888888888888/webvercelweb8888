        ...
        return `
            <a href="${googleUrl}" target="_blank" class="mock-ad-container banner-ad mb-4 w-100 d-block text-decoration-none">
                ...
                <div class="d-flex align-items-center h-100 p-2">
                    ...
                    <button class="btn btn-sm mock-ad-btn text-white px-4" style="background-color: ${color}; pointer-events: none;">${cta}</button>
                </div>
            </a>
        `;
    } else {
...
const adStyles = `
    <style>
        ...
        /* AdSense UI Overlays */
        .mock-ad-choices { position: absolute; top: 0; right: 0; display: flex; align-items: center; z-index: 10; background: rgba(255,255,255,0.9); padding: 0 0 2px 4px; border-bottom-left-radius: 4px; cursor: default; }
